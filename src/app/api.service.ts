...
export class ApiService {
  ...
  public delete() {
    return this.httpClient.delete(this.SERVER_URL).pipe(catchError(this.handleError));
  }

  public put() {
    //return this.httpClient.put(this.SERVER_URL).pipe(catchError(this.handleError));
  }
